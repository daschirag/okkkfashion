  ...
  return (
    <div className="min-h-screen overflow-y-clip bg-black text-white">
      <header className="flex mt-5 ml-3 justify-between items-center px-4 sm:px-6">
        <BackToProjectsButton theme="orange" variant="text" className="backdrop-blur-lg shadow-lg" />
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 mb-8 lg:mb-12">
          ...
          <div className="w-full lg:w-[30%] h-[300px] sm:h-[400px] lg:h-[500px] relative overflow-hidden rounded-lg">
            <Image
              src="/images/OrangeLeftImage.png"
              width={500}
              height={500}
              alt="Precocious Orange - Left View"
          ...
          <div className="w-full lg:w-[70%] flex flex-col">
            <div className="w-full h-[300px] sm:h-[400px] lg:h-[500px] relative overflow-hidden rounded-lg mb-4 lg:mb-6">
              <Image
                src="/images/OrangeRightImage.png"
                width={800}
                height={500}
                alt="Precocious Orange - Right View"
                className="w-full h-full object-contain md:object-cover object-center"
                priority
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
              <div className="flex-shrink-0 flex justify-start">
                ...
                <Image
                  src="/images/PRECOCIOUS-ORANGE.png"
                  width={600}
                  height={100}
                  alt="Precocious Orange Title"
        ...
        <div className="max-w-5xl mx-auto space-y-12 lg:space-y-16 px-4 sm:px-6 mb-16 lg:mb-24">
          ...
          <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 rounded-2xl p-6 sm:p-8 lg:p-10 border border-gray-700/30 backdrop-blur-sm">
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-200 font-light tracking-wide">
              A leather handbag that pays homage to the fierce Y2K fashion era, drawing inspiration from its bold
              aesthetic, features a nostalgic orange hue reminiscent of Fanta.
            </p>
          </div>
            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="border-l-2 border-pink-500/50 pl-6">
                <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-200 font-light tracking-wide">
                  ...
                  <span className="ml-2">To construct a shoulder bag taking an inspiration.</span>
                </p>
              </div>
              <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-200 font-light tracking-wide">
                The FANTA colour trend in 2000's served as the inspiration for this. Many people feel a connection to
                styles from their childhood or youth and enjoy seeing them reemerge in current fashion.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 rounded-2xl p-6 sm:p-8 lg:p-10 border border-gray-700/30 backdrop-blur-sm">
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-200 font-light tracking-wide">
              Flame like patterns, Textured materials, High quality materials, Unique closures, Distinctive strap
              design.
            </p>
          </div>
        </div>
